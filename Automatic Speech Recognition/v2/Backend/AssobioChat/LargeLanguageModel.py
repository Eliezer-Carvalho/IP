...
class LargeLanguageModelvLLM:
    ...
    def __init__ (self):
        ...
        with open (r"C:\Users\Admin\Desktop\ip\Automatic Speech Recognition\v2\Backend\AssobioChat\SYSTEM_PROMPT.md", "r", encoding = "utf-8") as f:
    ...
    def CHAT_MANAGER (self, PROMPT, HISTÓRICO):
